                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST"
                            ...
                            <div class="form-group{{ $errors->has('edad') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="edad" type="text" class="form-control" name="edad" value="{{ $user->edad or old('edad') }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('fechanacimiento') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="fechanacimiento" type="text" class="form-control" name="fechanacimiento" value="{{ $user->fechanacimiento or old('fecha') }}" autofocus>

                                    @if ($errors->has('fechanacimiebto'))
                                        <span class="help-block">
